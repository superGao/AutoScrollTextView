...
import com.example.autoscorllview.R;
...
public class LoadManmuActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_load_manmu);
        findViews();
    }
